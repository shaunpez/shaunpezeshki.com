  ...
  <Layout>
    <div className="container mx-auto">
      <div className="prose prose-lg max-w-none">
        ...
        <p>Pick a slot from my  <a href="https://calendly.com/shaunpez/coffee-chat" className="transition duration-300">Calendly link</a> (15-minute chats available). </p>
        <h3>Prefer email?</h3>
        <p>Reach out to me at <a href="mailto:shaun@uphighstudio.com" className="transition duration-300">shaun@uphighstudio.com</a>. You can also connect with me on social media.</p>  
        <h3>Curious about what I do?</h3>
        <p>
           Check out <a href="https://uphighstudio.com" className="transition duration-300">Up High Studio</a> and let's chat soon!
        </p>
      </div>
    </div>
  </Layout>

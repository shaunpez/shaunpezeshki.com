...
const IndexPage = ({ data }) => {
  ...
  return (
    <>
    <Seo
      title="Code & Quirks: Chronicles of a Weary Millennial Developer"
        ...
        <div className="container">
          <div className="content">
            <StaticImage
              ...
              alt="Code & Quirks: Chronicles of a Millennial Developer"
              placeholder="blurred" // Optional: This prop defines the loading strategy
            />
            <h1>Code & Quirks: <br />Chronicles of a Millennial Developer</h1>
